...
namespace hmd
{
    class Program
    {
        ...
        static string path = @"G:\user\PF\project\hmd\drs__info.txt";
        static string Covid__guides = @"G:\user\PF\project\hmd\covid__19-guide.txt";
        static string Covid__symptoms = @"G:\user\PF\project\hmd\covid__19-symptoms.txt";
        static string Pass_path = @"G:\user\PF\project\hmd\pass.txt";
        static string Username_path = @"G:\user\PF\project\hmd\username_info.txt";
        static string covid__report = @"G:\user\PF\project\hmd\covid__reports.txt";
        static string patient_info = @"G:\user\PF\project\hmd\patient_info.txt";
        static string drs_info = @"G:\user\PF\project\hmd\drs__info.txt";
